/*
 * esp2866-firmata-wifi-noisebridge.ino generated by FirmataBuilder
 * Sat Oct 21 2017 19:52:31 GMT-0400 (EDT)
 */

// TODO: use https://github.com/iamvery/artoo-neopixel/blob/master/firmata/StandardFirmata-NeoPixel.ino
...
void initTransport()
{
  ...
  DEBUG_PRINT("Attempting to connect to open SSID: ");
  DEBUG_PRINTLN(ssid);
  stream.begin(ssid);
